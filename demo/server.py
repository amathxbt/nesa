...
try:
    ...
    def create_interface():
        ...
        print("character is",shared.persistent_interface_state['character_menu'])
    ...
    if __name__ == "__main__":
        ...
        if shared.args.nowebui:
            ...
            for model_name in PRELOAD_MODELS:
                for output in ui_model_menu.download_model_wrapper(
                    repo_id=model_name, 
                    specific_file="",   
                    return_links=False,        
                    check=False                
            ...
            for output in ui_model_menu.load_model_wrapper(PRELOAD_MODELS[0].replace("/","_"), None, autoload=True):
                print(output)
    ...
    print("Caught an exception in library call:")
    print(e)
    traceback.print_exc()
    raise  # re-raise so you get the original context
